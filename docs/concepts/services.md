...
```
/clear [std_srvs/srv/Empty]                              # 그린 선 지우기
/kill [turtlesim/srv/Kill]                               # 거북이 삭제
/reset [turtlesim/srv/Empty]                             # 시뮬레이터 초기화
/spawn [turtlesim/srv/Spawn]                             # 새 거북이 생성
/turtle1/set_pen [turtlesim/srv/SetPen]                  # 펜 색상/두께 변경
...
```bash
# Spawn 서비스 구조 확인 (--- 위가 Request, 아래가 Response)
